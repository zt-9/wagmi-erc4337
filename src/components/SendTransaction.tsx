...
export function SendTransaction() {
	...
	// @notice This will not deploy a smart contract account if it does not exist. It simply loads the deterministic address where the smart account will be deployed.
	useEffect(() => {
	...
	return (
		<div className="container">
			<div className="stack">
				...
				{uoHash !== "0x" && <div>UserOperation Hash: {uoHash}</div>}
